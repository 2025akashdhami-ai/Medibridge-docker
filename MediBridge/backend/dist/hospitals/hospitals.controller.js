...
let HospitalsController = class HospitalsController {
    ...
    async updateResources(req, updateDto) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], HospitalsController.prototype, "getHospital", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('hospital'),
    (0, common_1.Put)('resources'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, hospitals_dto_1.UpdateResourcesDto]),
    __metadata("design:returntype", Promise)
], HospitalsController.prototype, "updateResources", null);
